...
class DemandaIyccVSMMPdfService {
    constructor(data) {
        this.data = data;
        this.contenidoDemanda = [
          ...
          {
            tipo: 'opcion-lista', contenido: [
              '<span class="negrita">c)</span> <span class="negrita">Intereses Ordinarios.</span> Por concepto de <span class="negrita">intereses ordinarios</span> no cubiertos generados desde el mes de <span class="negrita">«MES_PRIMER_ADEUDO»</span> <span class="negrita">HASTA</span> <span class="negrita">«MES_ULTIMO_ADEUDO»</span> y calculados en una tasa fija anual del <span class="negrita">«INTERES_ORDINARIO»</span> por ciento sobre saldos insolutos, lo anterior conforme a lo establecido en el contrato base de la acción, más los que se sigan generando hasta la fecha del pago total del importe del crédito y conforme a la liquidación que por dicho concepto se realice en ejecución de sentencia. El pago se deberá solventar el equivalente en Moneda Nacional multiplicando el monto de la obligación contraída en Veces el Salario Mínimo Mensual vigente en el Distrito Federal, correspondiente a día en que se efectúe el pago total.'
            ]
          },
        
          {
            tipo: 'opcion-lista', contenido: [
              '<span class="negrita">d)</span> <span class="negrita">Intereses Moratorios.</span> Pago en Moneda Nacional por concepto de <span class="negrita">intereses moratorios</span> no cubiertos generados desde la amortización correspondiente desde el mes de <span class="negrita">«MES_PRIMER_ADEUDO»</span> <span class="negrita">HASTA</span> <span class="negrita">«MES_ULTIMO_ADEUDO»</span> calculados a una tasa de interés del <span class="negrita">«INTERES_MORATORIO»</span> por ciento anual, tasa resultante de sumar la tasa anual del 4.2% y la tasa anual de Interés Ordinario, lo anterior de conformidad a lo establecido en el contrato de apertura de crédito, más los que se sigan generando hasta la fecha del pago total del importe del crédito y conforme a la liquidación que por dicho concepto se realice en ejecución de sentencia. El pago se deberá de solventar al equivalente en Moneda Nacional multiplicando el monto de la obligación contraída en “Veces el Salario Mínimo Mensual” vigente en el Distrito Federal, correspondiente al día en que se efectúe el pago total del adeudo.'
            ]
          },
          ...
          {
            tipo: 'romanos', contenido: [
              '<span class="negrita">II.-</span> Conforme a los fines de la Ley del Instituto del Fondo Nacional de la Vivienda para los Trabajadores, mi representada celebró con <<DEMANDADO>> <span class="negrita">C. «ACREDITADO»</span>, un <span class="negrita">CONTRATO DE APERTURA DE CRÉDITO SIMPLE CON GARANTÍA HIPOTECARIA</span>, como se justifica con la <span class="negrita">Escritura Pública número</span> <span class="negrita">«ESCRITURA»</span> <span class="negrita">de fecha</span> <span class="negrita">«FECHA_ESCRITURA_FT»</span> <span class="negrita">e inscrita ante el Registro Público de la Propiedad del Comercio, bajo el número de inscripción</span> <span class="negrita">«INSCRIPCION»</span>, <span class="negrita">Volumen</span> <span class="negrita">«VOLUMEN»</span>, <span class="negrita">Libro</span> <span class="negrita">«LIBRO»</span>, <span class="negrita">Sección</span> <span class="negrita">«SECCION»</span>, <span class="negrita">Unidad</span> <span class="negrita">«UNIDAD»</span>, <span class="negrita">«ESTADO»</span>, de fecha <span class="negrita">«FECHA_FT»</span>, el cual exhibo en primer testimonio original, para demostrar la existencia de dicha relación jurídica y los derechos y obligaciones adquiridos por las partes.'
            ]
          },
        
          {
            tipo: 'romanos', contenido: [
              '<span class="negrita">III.-</span> En el contrato con que se demanda, se desprende que mi representada le otorgó <<DEMANDADO_C2>> <span class="negrita">C. «ACREDITADO»</span>, un crédito por un monto equivalente a la cantidad de <span class="negrita">«MONTO_OTORGADO»</span> veces el Salario Mínimo Mensual en el Distrito Federal, crédito que fue totalmente dispuesto para destinarlo a la adquisición del inmueble descrito en el punto Primero del apartado de Antecedentes del documento base de la presente acción, siendo dicho inmueble respecto del cual se demanda la ejecución de garantía hipotecaria. Dicho crédito se registró bajo el número <span class="negrita">«CREDITO»</span>.'
            ]
          },
        
          {
            tipo: 'romanos', contenido: [
              'Así también, según lo establecido en el contrato de apertura de crédito, <<DEMANDADO_C>> <span class="negrita">C. «ACREDITADO»</span> reconoció adeudar y se obligó a pagar a mi representada, el monto del crédito otorgado, en los términos y condiciones que se precisan en el propio documento sustento de mi acción, aceptando que el saldo del crédito se ajuste cada vez al Salario Mínimo General vigente en el Distrito Federal.'
            ]
          },
        ...
        
          {
            tipo: 'lista', contenido: [
              ...
              '<li style="margin-bottom: 5px;">- <span class="negrita">1 juego de traslado</span></li>',
        ...
        
          {
            tipo: 'romanos',
            contenido: [
              'En el Municipio de <span class="negrita">«MUNICIPIO»</span>, <span class="negrita">«ESTADO»</span>, siendo las <span class="negrita">«HORA_REQUERIMIENTO»</span> horas del día <span class="negrita">«FECHA_REQUERIMIENTO_FT»</span>, el suscrito <span class="negrita">Lic. ALFREDO FUENTES CHAVARRÍA</span>, Apoderado Jurídico General para Pleitos y Cobranzas del <span class="negrita">Instituto del Fondo Nacional de la Vivienda para los Trabajadores</span>, en compañía de los testigos, <span class="negrita">C.C Ernesto Morales Ramírez y María Cristina Cruz Luna</span>, quienes se identifican con credenciales para votar expedidas por el Instituto Nacional Electoral, el primero con folio No. 1492130249568 y el segundo con folio No. 1171000699812, hago constar que me constituí <<DOMICILIO_DE>> <span class="negrita">C. «ACREDITADO»</span>, con relación al <span class="negrita">Contrato de Apertura de Crédito Simple con Garantía Hipotecaria</span> que la citada persona tiene celebrado con mi representada, protocolizado mediante Escritura Pública número <span class="negrita">«ESCRITURA»</span>, respecto al adeudo consistente en: El pago de la cantidad de <span class="negrita">«ADEUDO»</span> Veces el Salario Mínimo Mensual que se encuentre vigente en el Distrito Federal al momento de realizarse la liquidación total del adeudo, derivado de la disposición del crédito efectuada, conforme a lo establecido en el Contrato antes referido. En la inteligencia de que, al día de la emisión de la constancia de saldo, equivale a la suma de <span class="negrita">$«ADEUDO_PESOS» «ADEUDO_PESOS_FT»</span> por concepto de Capital Insoluto, el cual se deriva de la disposición del crédito efectuada, más las cantidades que por concepto de Intereses Ordinarios se hayan generado, de acuerdo con lo establecido en el contrato antes citado. Es importante mencionar que dicha cantidad resulta de multiplicar <span class="negrita"><<UNIDAD_B>></span> correspondiente al número de <<UNIDAD_M>> a la fecha en el Distrito Federal dado a conocer por la Comisión Nacional de Salarios Mínimos a partir del día primero de febrero del año 2024 y <span class="negrita">30.4</span> correspondiente al número de días promedio de cada mes, lo cual arroja la cantidad de <span class="negrita">$<<UNIDAD_C>></span> mismo que multiplicado por <span class="negrita">«ADEUDO»</span> veces el salario mínimo, arroja un monto de <span class="negrita">$«ADEUDO_PESOS» «ADEUDO_PESOS_FT»</span>. Cantidad que se incrementará en la misma proporción que se aumente el Salario Mínimo Diario Vigente en el Distrito Federal de acuerdo a lo pactado en el contrato de crédito.'
            ]
          },
        ...
        
          {
            ...
            contenido: [
              ...
              '<span class="negrita">CALLE «CALLE», NUMERO «NUMERO», «COLONIA_FRACCIONAMIENTO», «MUNICIPIO», «ESTADO».</span>',
              '</div>'
            ]
          },
        ...
        
          {
            tipo: 'parrafo',
            contenido: [
              'El pago en Moneda Nacional (pesos) del equivalente, el cual se deriva de la disposición del crédito efectuada por Usted, conforme a lo establecido en el contrato antes referido. En la inteligencia de que, al día de hoy equivale a la suma de <span class="negrita">$«ADEUDO_PESOS» «ADEUDO_PESOS_FT»</span>, es importante mencionar que dicha cantidad resulta de multiplicar <span class="negrita">«ADEUDO»</span> veces el salario mínimo mensual por <span class="negrita">30.4</span> correspondiente al número de días promedio de cada mes y multiplicado por el número de <<UNIDAD_M>> a la fecha en el Distrito Federal siendo <span class="negrita"><<UNIDAD_B>></span> dado a conocer por la Comisión Nacional de Salarios Mínimos a partir del día primero de febrero del año 2024, por concepto de <span class="negrita">Capital Insoluto</span>. Más las cantidades que por concepto de interés Ordinario y Moratorios, que se haya generado, de acuerdo a lo establecido en el contrato antes citado.'
            ]
          },
          ...
          },
          {
            tipo: 'romanos',
            contenido: [
              '<span class="negrita">II.</span> Que mi representada le otorgó un Crédito por la cantidad de «ADEUDO» Veces el Salario Mínimo Mensual Vigente en el Distrito Federal.'
            ]
          },
          {
            tipo: 'romanos',
...
export default DemandaIyccVSMMPdfService;