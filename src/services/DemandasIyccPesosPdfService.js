...
class DemandaIyccPesosPdfService {
    constructor(data) {
        ...
        this.contenidoDemanda = [
            ...
            tipo: 'parrafo',
            contenido: [
            'El pago en Moneda Nacional (pesos) del equivalente, el cual se deriva de la disposición del crédito efectuada por Usted, conforme a lo establecido en el contrato antes referido. En la inteligencia de que, al día de hoy equivale a la suma de <span class="negrita">$«ADEUDO_PESOS» «ADEUDO_PESOS_FT»</span>, es importante mencionar que dicha cantidad resulta de multiplicar <span class="negrita">$«ADEUDO» «ADEUDO_FT»</span>. Más las cantidades que por concepto de interés Ordinario y Moratorios, que se haya generado, de acuerdo a lo establecido en el contrato antes citado.'
            ]
            },
